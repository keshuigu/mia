...
@click.option(
    ...
    metavar="PKL|URL",
    type=str,
    # default='/home/yu/workspace/mia/training-runs/00037-celeba_feature-cond-ddpmpp-edm-gpus1-batch16-fp32-model1_run/network-snapshot-006109.pkl'
)
...
@click.option(
    ...
    metavar="PT",
    type=str,
    default="/home/yu/workspace/mia/training-runs/00040-celeba_feature-cond-ddpmpp-edm-gpus1-batch16-fp32-model2_run/training-state-008012.pt",
)
