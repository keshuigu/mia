...
@click.option(
    ...
    metavar="PKL|URL",
    type=str,
    default='/home/yu/workspace/mia/training-runs/00044-celeba_feature-cond-ddpmpp-edm-gpus4-batch16-fp32-model3_run/network-snapshot-003004.pkl'
)
...
def main(**kwargs):
    ...
    c.dataset_kwargs = dnnlib.EasyDict(
        ...
        path="/home/yu/celeba/img_align_celeba_112_train",
        feature_npz="/home/yu/celeba/celeba_arcface_features_align_train.npz",
        resolution=112,
        use_labels=True,
    )
